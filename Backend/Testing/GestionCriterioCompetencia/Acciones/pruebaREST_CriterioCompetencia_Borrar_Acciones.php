...
function pruebaREST_CriterioCompetencia_Borrar_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
	...
	//ELIMINAR_CRITERIO_COMPETENCIA_OK
	$POST = $vaciarPost;
    $POST['controller'] = 'criteriaCompetence';
    $POST['action'] = 'delete';
    $POST['id_criterio'] = $idCriterio;
	...
	$prueba = 'Criterio-Competencia eliminado correctamente.';
	$codeEsperado = 'ELIMINAR_CRITERIO_COMPETENCIA_OK';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
