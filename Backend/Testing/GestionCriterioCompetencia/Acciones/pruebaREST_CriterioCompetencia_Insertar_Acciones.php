...
function pruebaREST_CriterioCompetencia_Insertar_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
	...
	//ANADIR_CRITERIO_COMPETENCIA_OK
	$POST = $vaciarPost;
    $POST['controller'] = 'criteriaCompetence';
    $POST['action'] = 'add';
    $POST['id_criterio'] = $idCriterio;
	...
	$prueba = 'Criterio-Competencia añadido correctamente.';
	$codeEsperado = 'ANADIR_CRITERIO_COMPETENCIA_OK';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
