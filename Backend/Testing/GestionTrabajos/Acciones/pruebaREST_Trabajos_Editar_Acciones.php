...
function pruebaREST_Trabajos_Editar_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
	...
	//ACCION_DENEGADA_MODIFICAR_TRABAJO
	$POST = $vaciarPost;
    $POST['controller'] = 'project';
    $POST['action'] = 'edit';
	$POST['nombre_trabajo'] = 'Trabajo test';
	...
	$codeEsperado = 'ACCION_DENEGADA_MODIFICAR_TRABAJO';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$codeEsperado = 'EDITAR_TRABAJO_OK';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
