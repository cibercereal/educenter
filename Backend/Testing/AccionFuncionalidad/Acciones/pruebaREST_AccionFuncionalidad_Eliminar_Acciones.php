...
function pruebaREST_AccionFuncionalidad_Eliminar_Acciones() {
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    $prueba = 'Eliminar acción-funcionalidad correctamente.';
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$prueba = 'La relación acción-funcionalidad no existe.';
	$codeEsperado = 'ACCION_FUNCIONALIDAD_NO_EXISTE';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
