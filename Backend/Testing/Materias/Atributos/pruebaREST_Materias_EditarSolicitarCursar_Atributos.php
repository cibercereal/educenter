<?php
function pruebaREST_Materias_EditarSolicitarCursar_Atributos() {
    ...
    $test = 'Aceptado no puede estar vacío.';
    $expectedCode = 'ACEPTADO_VACIO';
    $tests->hacerPrueba($POST, $POST['controller'], $POST['action'], $type, $test, $expectedCode);

    //---------------------------------------------------------------------------------------------------------------------

    //ACEPTADO_MAYOR_QUE_1
    $POST = $emptyPost;
    $POST['controller'] = 'subjectStudent';
    $POST['action'] = 'edit';
    $POST['id_materia'] = '1';
    ...
    $test = 'Aceptado no puede ser mayor que 1.';
    $expectedCode = 'ACEPTADO_MAYOR_QUE_1';
    $tests->hacerPrueba($POST, $POST['controller'], $POST['action'], $type, $test, $expectedCode);

    //---------------------------------------------------------------------------------------------------------------------

    //ACEPTADO_ERROR_FORMATO
    $POST = $emptyPost;
    $POST['controller'] = 'subjectStudent';
    $POST['action'] = 'edit';
    $POST['id_materia'] = '1';
    ...
    $test = 'El formato de aceptado es erróneo.';
    $expectedCode = 'ACEPTADO_ERROR_FORMATO';
    $tests->hacerPrueba($POST, $POST['controller'], $POST['action'], $type, $test, $expectedCode);
