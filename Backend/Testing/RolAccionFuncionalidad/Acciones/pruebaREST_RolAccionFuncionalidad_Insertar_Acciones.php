...
function pruebaREST_RolAccionFuncionalidad_Insertar_Acciones(){
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    $prueba = 'Añadir rol-acción-funcionalidad correctamente.';
    $codeEsperado = 'RECORDSET_DATOS';
    $pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);

//---------------------------------------------------------------------------------------------------------------------

	//ROL_ACCION_FUNCIONALIDAD_EXISTE
	$POST = $vaciarPost;
	$POST['controller'] = 'roleActionFunctionality';
	$POST['action'] = 'add';
	$POST['checked'] = 'true';
	...
	$codeEsperado = 'ROL_ACCION_FUNCIONALIDAD_EXISTE';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    // Eliminar rol-acción-funcionalidad añadida
    $POST = $vaciarPost;
	$POST['controller'] = 'roleActionFunctionality';
	$POST['action'] = 'add';
	$POST['checked'] = 'false';
