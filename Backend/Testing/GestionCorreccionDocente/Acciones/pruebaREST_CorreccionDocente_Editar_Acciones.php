...
function pruebaREST_CorreccionDocente_Editar_Acciones(){
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    $codeEsperado = 'EDITAR_CORRECCION_DOCENTE_OK';
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $POST['controller'] = 'correctionTeacher';
    $POST['action'] = 'edit';
    $POST['id_correccion_profesor'] = '15000';
    $POST['correccion_docente'] = '1';
    $POST['comentario_docente'] = 'Comentario test';
