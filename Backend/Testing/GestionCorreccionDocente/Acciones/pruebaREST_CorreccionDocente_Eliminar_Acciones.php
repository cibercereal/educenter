...
function pruebaREST_CorreccionDocente_Eliminar_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    // ELIMINAR_CORRECCION_DOCENTE_OK
    $POST = $vaciarPost;
    $POST['controller'] = 'correctionTeacher';
    $POST['action'] = 'delete';
    $POST['id_correccion_profesor'] = $idCorreccion;

    $prueba = 'Corrección eliminada correctamente.';
    $codeEsperado = 'ELIMINAR_CORRECCION_DOCENTE_OK';
    $pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
