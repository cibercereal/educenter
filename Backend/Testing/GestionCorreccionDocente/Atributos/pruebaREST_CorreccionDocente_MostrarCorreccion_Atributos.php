...
function pruebaREST_CorreccionDocente_MostrarCorreccion_Atributos(){
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $POST['controller'] = 'correctionTeacher';
    $POST['action'] = 'showCorrection';
	$POST['id_correccion_profesor'] = '1';
	$POST['visible'] = '';

	$prueba = 'Visible no puede ser vacío.';
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$prueba = 'Visible tiene un formato no válido.';
