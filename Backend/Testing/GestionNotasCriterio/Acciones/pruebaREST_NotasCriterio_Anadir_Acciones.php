...
function pruebaREST_NotasCriterio_Anadir_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$prueba = 'Nota criterio añadida correctamente.';
	$codeEsperado = 'ANADIR_CALCULAR_NOTA_OK';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
