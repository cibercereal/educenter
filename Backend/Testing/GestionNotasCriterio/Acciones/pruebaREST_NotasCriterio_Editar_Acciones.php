...
function pruebaREST_NotasCriterio_Editar_Acciones(){
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    $POST['controller'] = 'gradeProject';
    $POST['action'] = 'edit';
	$POST['id_trabajo'] = '123456789';
	$POST['id_entrega'] = $idEntrega;
	$POST['nota_trabajo'] = '5';
	$POST['nota_correccion'] = '7.5';
	$POST['dni'] = '73972612N';
	$POST['visible'] = '0';

	$prueba = 'El id del trabajo no existe.';
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $POST['action'] = 'edit';
	$POST['id_trabajo'] = $idTrabajo;
	$POST['id_entrega'] = '123456789';
	$POST['nota_trabajo'] = '5';
	$POST['nota_correccion'] = '7.5';
	$POST['dni'] = '73972612N';
	$POST['visible'] = '0';

	$prueba = 'El id de la entrega no existe.';
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$prueba = 'Nota criterio modificada correctamente.';
	$codeEsperado = 'EDITAR_CALCULAR_NOTA_OK';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
