...
function pruebaREST_NotasCompetencia_Visualizar_Acciones(){
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $POST['controller'] = 'gradeCompetence';
    $POST['action'] = 'makeVisible';
	$POST['id_trabajo'] = '01234567890';
	$POST['id_materia'] = $idMateria;
	$POST['id_competencia'] = $idCompetencia;
	$POST['dni'] = $dni;
	$POST['visible'] = '1';

	$prueba = 'El trabajo no existe.';
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$POST['id_trabajo'] = $idTrabajo;
	$POST['id_materia'] = $idMateria;
	$POST['id_competencia'] = '01234567890';
	$POST['dni'] = $dni;
	$POST['visible'] = '1';

	$prueba = 'La competencia no existe.';
...
//---------------------------------------------------------------------------------------------------------------------
	...
	$prueba = 'Nota publicada correctamente.';
	$codeEsperado = 'PUBLICAR_NOTA_COMPETENCIA_OK';
	$pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
