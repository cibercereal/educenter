...
function pruebaREST_CorreccionCriterio_Editar_Acciones(){
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    // EDITAR_CORRECCION_CRITERIO_OK
    $POST = $vaciarPost;
    $POST['controller'] = 'correctionCriteria';
    $POST['action'] = 'edit';
    $POST['id_correccion_criterio'] = $idCorreccion;
    $POST['correccion_alumno'] = '1';
    $POST['comentario_alumno'] = 'Comentario test';

    $prueba = 'Corrección editada correctamente.';
    $codeEsperado = 'EDITAR_CORRECCION_CRITERIO_OK';
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    // CORRECCION_NO_PERTENECE_ALUMNO
    $POST = $vaciarPost;
    $POST['controller'] = 'correctionCriteria';
    $POST['action'] = 'edit';
    $POST['id_correccion_criterio'] = $idCorreccion;
    ...
    $prueba = 'Corrección no pertenece al alumno logueado.';
    $codeEsperado = 'CORRECCION_NO_PERTENECE_ALUMNO';
    $pruebas->hacerPrueba($POST, $POST['controller'], $POST['action'], $tipo, $prueba, $codeEsperado);
