...
function pruebaREST_CorreccionCriterio_Buscar_Acciones(){
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    $prueba = 'El usuario no es profesor o alumno.';
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    $prueba = 'No hay correcciones con los parámetros buscados.';
