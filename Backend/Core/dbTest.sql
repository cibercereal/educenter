...
CREATE DATABASE IF NOT EXISTS `dbTest` DEFAULT CHARACTER SET latin1;
...
INSERT INTO `usuario` (`dni`, `nombre`, `apellidos_usuario`, `email`, `password`, `id_rol`, `direccion`, `telefono`, `fecha_nac`)
VALUES ('05109923J', 'profesor', 'profesor profesor', 'profesor@profesor.es', '21232f297a57a5a743894a0e4a801fc3', '2', 'profesor', '666555444', '2013-04-09');
INSERT INTO `usuario` (`dni`, `nombre`, `apellidos_usuario`, `email`, `password`, `id_rol`, `direccion`, `telefono`, `fecha_nac`)
VALUES ('73972612N', 'alumno', 'alumno alumno', 'alumno@alumno.es', '21232f297a57a5a743894a0e4a801fc3', '3', 'alumno', '666555444', '2013-04-09');
...
(1, 'Interfaces de usuario', '60', NULL, 1),
(2, 'Bases de datos', '20', '14488423X', 1);